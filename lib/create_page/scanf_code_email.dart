...
class ScanfCodeEmail extends StatefulWidget {
  const ScanfCodeEmail({super.key});

  @override
  State<ScanfCodeEmail> createState() => _ScanfCodeEmailState();
}

class _ScanfCodeEmailState extends State<ScanfCodeEmail> {
  @override
